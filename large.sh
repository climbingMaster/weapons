...
dir=/home/saiteja/weapons
results=/home/saiteja/Recon/$domain
red=`tput setaf 1`
green=`tput setaf 2`
reset=`tput sgr0`
...
# Performing Screenshoting website
    echo '-----------------------------------------------------'
    echo "${red} Performing : ${green} Screenshoting website ${reset}"
    echo '-----------------------------------------------------'
    $dir/screenshot.sh $domain;
    echo '-----------------------------------------------------'
    echo "${red} Finished : ${green} Results are saved in ${results} folder ${reset}"
    echo '-----------------------------------------------------'
# Finished Screenshoting website
